...
class Datos extends Conexion{
    ...
    public function registroProductosModel($datosModel, $tabla){
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, descripcion, precio_compra, precio_venta, inventario, id_categoria) VALUES(:nombre, :descripcion, :precio_compra, :precio_venta, :inventario, :id_categoria) ");
